    ...
    return (
        <section className='banner w-full relative'>
            <div className='w-full h-[calc(100vh-56px)] z-0'>
                {
                    ...
                    // <img className={`
                    //     max-[426px]:bg-[url('/assets/vase-mobile.webp')] 
                    //     min-[425px]:bg-[url('/assets/vase-desktop.webp')]
                    //     bg-cover w-full h-full object-cover`} 
                    //     alt="banner-image" 
                    // />
                }
                {
            ...
            <div className='w-full absolute flex flex-col gap-2 bottom-10 z-20 text-center xl:bottom-20 xl:left-16 xl:w-fit'>
                ...
                <h2 className='text-xl md:text-4xl tracking-wider text-white font-bold mb-4 px-8 xl:px-0'>
                    {value.heading}
                </h2>
                <button className='relative left-1/2 -translate-x-1/2 w-fit whitespace-nowrap tracking-widest font-bold 
                    bg-white text-black border border-white hover:bg-white hover:text-black transition-all ease-in-out
                    px-6 py-1.5
                    lg:py-3 lg:bg-transparent lg:px-8 lg:text-white
