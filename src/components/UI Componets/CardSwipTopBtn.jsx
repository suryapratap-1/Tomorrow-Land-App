...
const CardSwipTopBtn = ({scrollLeft, scrollRight, category, value, like, id}) => {
    ...
    return (
        <section className='md:pb-8'>
            ...
            <div className={`${id} no-scrollbar pb-4 scroll-smooth flex gap-5 overflow-x-auto md:overflow-x-hidden`}>
                {
                    category.map((item) => (
