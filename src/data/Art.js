...
export const drawingDescription = {
    heading: 'CONCEPT ART',
    text: 'The Great Library Studios are Tomorrowland’s in-house creative department, where imagination and creativity converge to reveal the extraordinary. Step into a mesmerizing space that invites you on a visual journey.'
}
...
export const paintingsDescription = {
    heading: 'PHOTO ART COLLECTION',
    text: 'Choose from a number of breathtaking photographs and bring the atmosphere of Tomorrowland to your home.'
}